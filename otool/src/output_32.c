...
/*   Updated: 2018/11/10 18:54:57 by ysan-seb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		struct segment_command *seg)
{
	...
	ret = 0;
	s = get_section_32(st, (void*)(seg + 1), h->magic, 0);
	if (!s)
		return (ERR);
