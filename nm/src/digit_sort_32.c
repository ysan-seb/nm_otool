...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/11/09 16:19:25 by ysan-seb          #+#    #+#             */
/*   Updated: 2018/11/09 17:52:59 by ysan-seb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static struct nlist	*sort_digit_32(void *ptr,
		struct nlist *array, struct symtab_command *s)
{
	uint32_t	i;
	char		*s1;
		...
		struct nlist *array, struct symtab_command *s)
{
	while (1)
	{
		if (!(array = sort_digit_32(ptr, array, s)))
			return (NULL);
