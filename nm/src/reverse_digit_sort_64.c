...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   reverse_digit_sort_64.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: ysan-seb <ysan-seb@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/11/09 17:02:24 by ysan-seb          #+#    #+#             */
/*   Updated: 2018/11/09 17:43:54 by ysan-seb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static struct nlist_64	*reverse_sort_ascii_64(void *ptr,
		struct nlist_64 *array, struct symtab_command *s)
{
	uint32_t	i;
	char		*s1;
		...
		struct nlist_64 *array, struct symtab_command *s)
{
	while (1)
	{
		if (!(array = reverse_sort_ascii_64(ptr, array, s)))
			return (NULL);
